...
describe EIP55::Address do
  ...
  describe "#checksummed" do
    let(:addresses) do
      [
        # downcased
        %w[0x5aaeb6053f3e94c9b9a09f33669435e7ef1beaed 0x5aAeb6053F3E94C9b9A09f33669435E7Ef1BeAed],
        %w[0xfb6916095ca1df60bb79ce92ce3ea74c37c5d359 0xfB6916095ca1df60bB79Ce92cE3Ea74c37c5d359],
        %w[0xdbf03b407c01e7cd3cbea99509d93f8dddc8c6fb 0xdbF03B407c01E7cD3CBea99509d93f8DDDC8C6FB],
        %w[0xd1220a0cf47c7b9be7a2e6ba89f429762e7b9adb 0xD1220A0cf47c7B9Be7A2E6BA89F429762e7b9aDb],
        # upcased
        %w[0x5AAEB6053F3E94C9B9A09F33669435E7EF1BEAED 0x5aAeb6053F3E94C9b9A09f33669435E7Ef1BeAed],
        %w[0xFB6916095CA1DF60BB79CE92CE3EA74C37C5D359 0xfB6916095ca1df60bB79Ce92cE3Ea74c37c5d359],
        %w[0xDBF03B407C01E7CD3CBEA99509D93F8DDDC8C6FB 0xdbF03B407c01E7cD3CBea99509d93f8DDDC8C6FB],
    ...
    it "follows EIP55 standard" do
      addresses.each do |plain, checksummed|
        assert_equal checksummed, EIP55::Address.new(plain).checksummed
      end
    end
